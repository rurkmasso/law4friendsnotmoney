...
<h1>${templateName}</h1>
<p style="text-align:center;color:#9ca3af;font-size:12px;">${lang === "mt" ? "Ġenerat minn" : "Generated by"} SacLigi — ${new Date().toLocaleDateString()}</p>
...
<div class="footer">
<p>${lang === "mt" ? "Dan id-dokument ġie ġenerat minn SacLigi. Mhux parir legali." : "This document was generated by SacLigi. Not legal advice."}</p>
