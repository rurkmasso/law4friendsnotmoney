...
<h1>${caseName}</h1>
<p style="text-align:center;color:#9ca3af;font-size:13px;">${lang === "mt" ? "Ġenerat minn" : "Generated by"} Tizzju — ${new Date().toLocaleDateString()}</p>
...
`).join("\n<hr>\n")}
<div class="footer">
<p>Tizzju — ${lang === "mt" ? "Il-Liġi Maltija Miftuħa għal Kulħadd" : "Free Maltese Legal Intelligence"}</p>
